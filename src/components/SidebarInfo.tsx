...
export function SidebarInfo({ isAdmin, user, onOpenAdmin, onClose }: SidebarInfoProps) {
  ...
  return (
    <aside className="p-6 h-full flex flex-col justify-between overflow-y-auto custom-scrollbar bg-bg text-secondary border-r border-border-dim">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2">
                {isAdmin && (
                  <button 
                    onClick={onOpenAdmin}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-accent text-bg hover:bg-orange-accent hover:text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-lg transition-all shadow-lg"
                  >
